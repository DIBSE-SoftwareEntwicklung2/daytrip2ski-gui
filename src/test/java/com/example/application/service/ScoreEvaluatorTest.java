...
class ScoreEvaluatorTest {
    ...
    void setUp() {
        ...
        scoreEvaluator = new ScoreEvaluator(rps, dms);
    ...
    void resolveTimeRecommended() {
        ...
        assertEquals(new Result(true, "", 55, true, new ArrayList<>()), result);
    ...
    void resolveTimeNotRecommendedActive() {
        ...
        assertEquals(new Result(true, "", 55, false, expected), result);
    }
    ...
    void resolveTimeNotRecommendedTime() {
        ...
        assertEquals(result, new Result(true, "", 55, false, expected));
