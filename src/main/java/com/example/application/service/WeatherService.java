...
public class WeatherService {
    ...
    public WeatherActualReturn getWeatherActual(String WeatherActualUri) {
        //System.out.println( env.getProperty("api.baseurl"));
        WebClient.RequestHeadersSpec<?> spec = WebClient.create().get().uri( WeatherActualUri );
    ...
    public WeatherForecastReturn getWeatherForecast(String WeatherForecastUri){
        WebClient.RequestHeadersSpec<?> spec = WebClient.create().get().uri(WeatherForecastUri);
